  ...
  public AdHistorialInvercion(final String use, final String pas)
  {
    ...
    btnEliminar.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent arg0)
      {
        ...
        String fecha1=Integer.toString(año1)+"-"+Integer.toString(mes1)+"-"+Integer.toString(dia1);
        String fecha2=Integer.toString(año2)+"-"+Integer.toString(mes2)+"-"+Integer.toString(dia2);
