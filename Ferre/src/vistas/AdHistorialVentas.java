...
public class AdHistorialVentas
  extends JFrame
{
  ...
  public static void main(String[] args)
  {
    EventQueue.invokeLater(new Runnable()
    {
      public void run()
      {
        try
        {
          AdHistorialVentas frame = new AdHistorialVentas();
  ...
  public AdHistorialVentas(final String use, final String pas)
  {
	  Alert ale = new Alert();
		ale.Alertame();
    setResizable(false);
    ...
    lblHistorialDeGastos.setBounds(32, 29, 334, 75);
    this.contentPane.add(lblHistorialDeGastos);
    
    JLabel lblGastos = new JLabel("Ventas");
    ...
    lblCedula.setBounds(12, 178, 28, 29);
    ...
    btnAtras.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        ...
        AdHistorialVentas.this.setVisible(false);
      }
    });
    btnAtras.setFont(new Font("Times New Roman", 0, 16));
    btnAtras.setBackground(new Color(51, 255, 102));
	...
	public void actionPerformed(ActionEvent arg0)
      {
        int filas = AdHistorialVentas.this.table.getRowCount();
        for (int i = 0; filas > i; i++) {
          modelo.removeRow(0);
        }
        int año1 = date1.getCalendar().get(1);
        int mes1 = date1.getCalendar().get(2) + 1;
        int dia1 = date1.getCalendar().get(5);
        
        int año2 = date2.getCalendar().get(1);
